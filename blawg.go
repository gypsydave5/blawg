...
func MakeBlawg(postDirectory, pagesDirectory, templateDirectory, extrasDirectory, siteDirectory string) error {
	...
	pages, err := getPages(pagesDirectory)
	if err != nil {
		return err
	}

	err = makePages(siteDirectory, pages, t)
	if err != nil {
		return err
	}
